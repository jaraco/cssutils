...
#            self.assertEqual(codec.detectencoding_str(u'\xef'.encode()), (None, False))
#            self.assertEqual(codec.detectencoding_str(u'\xef\x33'.encode()), ("utf-8", False))
#            self.assertEqual(codec.detectencoding_str(u'\xef\xbb'.encode()), (None, False))
#            self.assertEqual(codec.detectencoding_str(u'\xef\xbb\x33'.encode()), ("utf-8", False))
#            self.assertEqual(codec.detectencoding_str(u'\xef\xbb\xbf'.encode()), ("utf-8-sig", True))
#            self.assertEqual(codec.detectencoding_str(u'\xff'.encode()), (None, False))
#            self.assertEqual(codec.detectencoding_str(u'\xff\x33'.encode()), ("utf-8", False))
#            self.assertEqual(codec.detectencoding_str(u'\xff\xfe'.encode()), (None, False))
#            self.assertEqual(codec.detectencoding_str(u'\xff\xfe\x33'.encode()), ("utf-16", True))
#            self.assertEqual(codec.detectencoding_str(u'\xff\xfe\x00').encode(), (None, False))
#            self.assertEqual(codec.detectencoding_str(u'\xff\xfe\x00\x33'.encode()), ("utf-16", True))
#            self.assertEqual(codec.detectencoding_str(u'\xff\xfe\x00\x00'.encode()), ("utf-32", True))
...
#            self.assertEqual(codec.detectencoding_str(u'\x00\x00\xfe'.encode()), (None, False))
...
#            self.assertEqual(codec.detectencoding_str(u'\x00\x00\xfe\xff'.encode()), ("utf-32", True))
#            self.assertEqual(codec.detectencoding_str(u'@'.encode()), (None, False))
