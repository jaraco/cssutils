...
#        self.assertEqual(codec.detectencoding_unicode(u'@charset "x'.encode()), (None, False))
#        self.assertEqual(codec.detectencoding_unicode(u'a {}'.encode()), ("utf-8", False))
#        self.assertEqual(codec.detectencoding_unicode(u'@charset "x'.encode(), True), (None, False))
#        self.assertEqual(codec.detectencoding_unicode(u'@charset "x"'.encode()), ("x", True))
#
